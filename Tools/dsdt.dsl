 ...
 *
 * Disassembly of dsdt.aml, Sun Feb 19 11:24:07 2017
 *
 *
 ...
 */
DefinitionBlock ("dsdt.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000031)
{
    External (GSMI)
    External (DIDX)
    External (SGMD)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xC8631E18, 0x10)
        ...
        Device (AMW0)
        {
            ...
            Method (DSTS, 1, Serialized)
            {
                ...
                While (One)
                {
                    ...
                    Else
                    {
                        If (LEqual (_T_0, 0xA0000030))
                        {
                            \_SB.SIRS ()
                        }
                        Else
                        {
                            If (LEqual (_T_0, 0xA0000040))
                            {
                                \_SB.SRAD ()
                            }
                            Else
