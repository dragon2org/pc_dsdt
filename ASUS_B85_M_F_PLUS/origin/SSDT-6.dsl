 ...
 *
 * Disassembly of SSDT-6.aml, Mon Feb 20 11:56:05 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000034E1 (13537)
 *     Revision         0x01
 *     Checksum         0x8A
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 1, "SaSsdt", "SaSsdt ", 0x00003000)
{
     ...
     * disassembly, but only 19 were resolved (3 unresolved). Additional
    ...
    OperationRegion (SANV, SystemMemory, 0xC8883E18, 0x016D)
